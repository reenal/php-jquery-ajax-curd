...
$(document).ready(function (){
	...
	$('#ins_rec').on("submit", function(e){
		e.preventDefault();
		//var test =$(this).serializeArray();  // work or serialize
		//var asas=JSON.stringify(test);

		//(alert(test);

		//serializeArray
		//var x = $("form").serializeArray(); 
		//alert( $(this).serializeObject().done(function(o){);
